...
package completeExportMod.completeExportFeat;
import pom.completeExportPage;
import java.io.File;
...
public class completeExportScript extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new completeExportPage(driver).userName,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new completeExportPage(driver).userPassword,"Opal@1234");
        ...
        try
        {
            actions.EnterData(new completeExportPage(driver).userLogin,"userLoginValue");
